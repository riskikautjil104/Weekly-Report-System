...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'WeeklyReport') }}</title>
    ...
    <body class="min-h-screen bg-[#0a0b0d] font-sans text-[#e2e2e4] antialiased">
        <div class="relative min-h-screen overflow-hidden">
            ...
            <header class="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
                ...
                <a href="{{ url('/') }}" class="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/75 backdrop-blur transition hover:bg-white/10 hover:text-white">
