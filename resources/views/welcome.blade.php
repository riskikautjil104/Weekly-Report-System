...
<nav class="nav" id="mainNav" role="navigation" aria-label="Navigasi utama">
  <div class="nav-inner">
    ...
    <div class="nav-actions">
      <a href="{{ route('login') }}" class="btn-ghost" style="display:inline-flex;align-items:center;text-decoration:none;">Login</a>
      <a href="{{ route('login') }}" class="btn-primary" style="display:inline-flex;align-items:center;text-decoration:none;">Mulai</a>
    </div>
  </div>
</nav>
...
<section class="hero" id="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-cta">
      <a href="{{ route('login') }}" class="btn-hero-primary" style="text-decoration:none;">
        Masuk ke Dashboard
...
<section class="cta-section" id="cta">
  <div class="cta-card reveal">
    ...
    <div class="cta-actions">
      <a href="{{ route('login') }}" class="btn-cta" style="text-decoration:none;">
        Masuk Sekarang
        <span class="material-symbols-outlined" style="font-size:20px">arrow_forward</span>
      </a>
    </div>
