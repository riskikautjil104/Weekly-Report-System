                ...
                <form method="POST" action="<?php echo e(route('profile.update')); ?>" class="mt-5 space-y-4">
                    ...
                    <label class="block space-y-2">
                        ...
                        <input
                            ...
                            class="w-full rounded-xl border border-outline-variant bg-white px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
                            required
                        >
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <label class="block space-y-2">
                        ...
                        <input
                            ...
                            value="<?php echo e(old('whatsapp_number', $user->whatsapp_number)); ?>"
                            placeholder="+62..."
                            class="w-full rounded-xl border border-outline-variant bg-white px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
                        >
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/rizkihiibrahim/Downloads/weekly_report/projects/weekly-report/resources/views/profile/edit.blade.php ENDPATH**/ ?>