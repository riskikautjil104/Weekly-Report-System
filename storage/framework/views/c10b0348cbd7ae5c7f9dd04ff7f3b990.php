    ...
    <div class="flex h-full flex-col px-4 py-6">
        <div class="mb-6 rounded-2xl border border-outline-variant bg-surface-container-lowest p-4 shadow-sm">
            <div class="flex items-center gap-3">
                 <img src="<?php echo e(asset('assets/img/logosite.png')); ?>" alt="Logo" class="h-14 w-14 rounded-xl object-contain bg-white p-1">
...
<?php /**PATH /Users/rizkihiibrahim/Downloads/folder tanpa judul/projects/weekly-report/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>