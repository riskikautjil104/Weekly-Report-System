<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <section class="rounded-2xl border border-outline-variant bg-surface-container-lowest p-6 shadow-sm">
            <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="grid gap-4 lg:grid-cols-[1.3fr_0.7fr_0.7fr_auto]">
                ...
                <label class="space-y-2">
                    ...
                    <select name="role" class="w-full rounded-xl border border-outline-variant bg-white px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20">
                        <?php $__currentLoopData = $filters['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($role); ?>" <?php if(($filters['role'] ?? 'all') === $role): echo 'selected'; endif; ?>>
                ...
                <label class="space-y-2">
                    ...
                    <select name="status" class="w-full rounded-xl border border-outline-variant bg-white px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20">
                        <?php $__currentLoopData = $filters['statuses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>" <?php if(($filters['status'] ?? 'all') === $status): echo 'selected'; endif; ?>>
                ...
                <div class="flex items-end gap-3">
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-outline-variant bg-white px-4 py-3 text-sm font-semibold text-secondary transition hover:bg-surface-container-high">
                        Reset
                    </a>
                </div>
            </form>
...
<?php endif; ?></td>
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="inline-flex items-center justify-end gap-2">
                                        <a href="<?php echo e(route('admin.users.edit', $user['id'])); ?>" class="rounded-lg p-1.5 text-outline transition-colors hover:bg-primary-fixed hover:text-primary" aria-label="Edit user">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/rizkihiibrahim/Downloads/folder tanpa judul/projects/weekly-report/resources/views/admin/users/index.blade.php ENDPATH**/ ?>